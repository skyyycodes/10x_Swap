...
function CryptoTable({ cryptos }: { cryptos: Cryptocurrency[] }) {
  return (
    <div className="rounded-md border border-gray-200/20 bg-gradient-to-br from-white to-[#113CFC]/5 dark:from-neutral-900 dark:to-[#F3C623]/5 dark:border-[#F3C623]/10 hover:shadow-[#113CFC]/10 dark:hover:shadow-[#F3C623]/20">
      <Table>
